<h1 align="center"> qool-bash-loop </h1>

## 💖 Welcome Dear Friend!
> You are visiting the qoolixiloop **bash** repository. Please read on, if you like to find out, how you can profit from it.  
> Enjoy!  
> :sparkles:


### ⏳ TL;DR 
> Please click the Wiki link above, where you can find my Bash tutorials. 
...
[//]: # (links only needed for 'qool-bash-loop')
